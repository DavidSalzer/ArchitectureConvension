var priceArr, startDay, endDay, hotelType, roomType, bedType, daysCount, sum;
var dataObj = {
...
$(document).ready(function () {
    ...
    priceArr = [[7371, 11466,13338], [6435, 9360, 11232], [4680, 7722, 9126]];
	...
	// if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
		// $('#register-hotel').change(function(){
				// if($(this).val()=='3'){
					// $("#register-room-type option[value='1']").attr('disabled','disabled').hide();
				// }
				// else {
					// $("#register-room-type option[value='1']").removeAttr('disabled').show()
				// }
			// });
	// } else {
		// $('#register-hotel').change(function(){
				// if($(this).val()=='3'){
					 // $("#register-room-type option[value='1']").hide();
				 // }
				 // else {
					 // $("#register-room-type option[value='1']").show()
				 // }
			// });
