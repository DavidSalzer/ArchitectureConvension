...
<footer>
    <div style="text-align: center; margin-bottom: 20px;"><a href="http://www.adira.co.il/" target="_blank"><img class="img-logo" src="<?php echo get_template_directory_uri() . '/images/kadira_logo.png'; ?>" alt="הדירה - שיפוץ ובנייה" title="הדירה - שיפוץ ובנייה" /></a></div>
