    ...
    <div class="landing">
        ...
        if (is_active_widget(false, false, 'ef_registration') && is_array( $widget_ef_registration ) ) {
			...
			if( $reg_widget['registrationshowcalltoaction'] == 1 ) { ?>
				...
				<a href="http://architecture.co.il.tigris.nethost.co.il/%D7%94%D7%A8%D7%A9%D7%9E%D7%94-%D7%9C%D7%95%D7%A2%D7%99%D7%93%D7%AA-%D7%94%D7%90%D7%93%D7%A8%D7%99%D7%9B%D7%9C%D7%99%D7%9D/" class="btn btn-lg btn-secondary sign-up-btn">רישום לועידת האדריכלות</a>
        	<?php 
			}
		} ?>
