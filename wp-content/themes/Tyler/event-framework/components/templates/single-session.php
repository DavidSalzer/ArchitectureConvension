        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 sessions single">
                    <div class="session">
                        <span class="location"><?php _e('Location:', 'dxef'); ?> <strong><?php echo(!empty($locations) ? $locations[0]->name : ''); ?></strong></span><span><?php _e('Host:', 'dxef'); ?> <?php echo(!empty($hosts) ? $hosts[0]->name : ''); ?></span>
