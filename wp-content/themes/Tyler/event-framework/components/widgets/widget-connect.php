        ...
        <div class="connect">
            <div class="connect-inner">
                ...
                <div class="links">
                    ...
                    ?>
                    <a href="<?php echo esc_url( $ef_options['ef_twitter'], $esc_url_protocols ); ?>" target="_blank" title="Twitter" class="twitter"><i class="icon-twitter"></i></a><?php
                        
                        }
                        if ( ! empty( $ef_options['ef_google_plus'] ) ) {
                    ?>
                    <a href="<?php echo esc_url( $ef_options['ef_google_plus'], $esc_url_protocols ); ?>" target="_blank" title="Google+" class="googleplus"><i class="icon-googleplus"></i></a><?php
                        }
                        if ( ! empty( $ef_options['ef_facebook'] ) ) {
                    ?>
                    <a href="<?php echo esc_url( $ef_options['ef_facebook'], $esc_url_protocols ); ?>" target="_blank" title="Facebook" class="facebook"><i class="icon-facebook"></i></a><?php
                        }
