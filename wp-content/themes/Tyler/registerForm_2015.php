<?php
    /*
          Template Name: Embedded Register Page 2015
      */
...
<?php
    ...
    wp_enqueue_script('nadlan-register', get_template_directory_uri() . '/js/nadlan-register-15.js', array('jquery'), false, true);   
            ...
            <!--<div class="row">
                <div class="col-sm-11">
                    ...
                    <select id="register-end-day">
                        ...
                        <option value="1">02/12/2015 - יום ד'</option>
                        <option value="2">03/12/2015 - יום ה'</option>
                    </select>
                </div>
            </div>-->
            <div class="row">
...
<option value="24156">זכיין</option>							
    ...
    <!--<iframe id='pixel' frameborder="0" scrolling="no" width="1" height="1"></iframe>-->
</div>
